	...
	constructor (props){
		...
		handleSubmit = e => {
			...
			gql.request(`
			  ...
			  }`, {price: this.state.price, latFrom: this.props.latLngFrom.lat, longFrom: this.props.latLngFrom.lng, latTo: this.props.latLngTo.lat, longTo: this.props.latLngTo.lng}
			  )
			);
